...
if (usersignupForm) usersignupForm.addEventListener("submit", async (e)=>{
    e.preventDefault();
...
},{"@babel/polyfill":"dTCHC","./login":"7yHem","./mapbox":"3zDlz","./updateSettings":"l3cGY","./signup":"fNY2o","./stripe":"10tSC"}],"dTCHC":[function(require,module,exports) {
"use strict";
...
},{"15ebea833de5dfad":"kK3zc","95ab5a78ea5afa2c":"hNMxA","303cfc8ddbcb2805":"5hmIG","6591c618cfb7cd4c":"5PUEw","8605a9285bc04c5e":"l64VA","4bd024e32ba14834":"fX1nO","4abcf4a29859f47a":"hza6O"}],"dXNgZ":[function(require,module,exports) {
/**
...
parcelHelpers.export(exports, "forgotPasswordSet", ()=>forgotPasswordSet);
...
const forgotPasswordSet = async (data)=>{
    try {
        ...
        if (res.data.status == "success") {
            (0, _alerts.showAlert)("success", "Redirecting To Reset Password Page");
...
const signup = async (details)=>{
    try {
        const res = await (0, _axiosDefault.default).post("api/v1/users/signup", details);
        if (res.data.status == "success") {
...
const bookTour = async (tourId)=>{
    ...
    try {
        const session = await (0, _axiosDefault.default).get(`http://localhost:8000/api/v1/booking/checkout-session/${tourId}`);
